...
<form action="<?php echo URLROOT; ?>/przychodzace/edytuj/<?php echo $data['id']; ?>" method="post">
  ...
  <div class="row mb-3"><!-- pismo-faktura -->
    <div class="col-md-8 mx-auto bg-light py-3">
        <input type="hidden" name="czyFaktura" value="<?php echo $data['czy_faktura']; ?>">

        <?php if ($data['czy_faktura'] != '1') : ?>
        <div class="form-group row">
        ...
        <input type="hidden" name="liczbaZalacznikow" value="0">
        <input type="hidden" name="dekretacja" value="0">
