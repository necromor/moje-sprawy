...
<form action="<?php echo URLROOT; ?>/postanowienia/edytuj/<?php echo $data['id']; ?>" method="post">
  ...
  <div class="row my-4">
    ...
    <a href="<?php echo URLROOT; ?>/postanowienia/zestawienie/<?php echo $data['rok']; ?>" class="btn btn-info offset-md-4 col-md-4"><i class="fa fa-angle-double-left"></i> Wróć do zestawienia</a>
    <?php else : ?>
